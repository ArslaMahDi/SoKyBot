...
local url , res = https.request('http://veer.gamemodsm.xyz/?User='..SUDO_USER)
if res ~= 200 then
...
veer = Token:match("(%d+)")
redis:mset(
veer..":VERSION",GetUser.information.Source_version,
veer..":SUDO_ID:",GetUser.information.id,
veer..":DataCenter:",GetUser.information.DataCenter,
veer..":UserNameBot:",BOT_User,
veer..":NameBot:",BOT_NAME,
"VEER_INSTALL","Yes"
)
...
print('\27[0;33m>>'..Veerlogo..'\027[0;32m')
create_config()
else
...
if msg.type ~= "pv" and redis:get(veer..'sender:'..msg.sender_user_id_..':'..msg.chat_id_..'flood') then
...
if msg.GroupActive and redis:get(veer..'mute_tgservice'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_)
end
return false 
end
...
if msg.GroupActive and ZISBOT and redis:get(veer..'lock_bots_by_kick'..msg.chat_id_) then
kick_user(msg.sender_user_id_, msg.chat_id_)
end
if msg.content_.members_[0].id_ == our_id and redis:get(veer..':WELCOME_BOT') then
SUDO_USER = redis:hgetall(veer..'username:'..SUDO_ID).username
...
if msg.content_.ID == "MessageChatJoinByLink" and redis:get(veer..':lock_Add_User:'..msg.chat_id_) then 
...
if msg.text and not msg.forward_info_ and ScriptFile.iVeer then
...
if Text:match(Veer) then -- Check Commands To admin
if not CheckFlood(msg.sender_user_id_,msg.chat_id_,3) and not msg.SudoUser then
print("user is flood")
redis:setex(veer..'sender:'..msg.sender_user_id_..':'..msg.chat_id_..'flood',10,true)
kick_user(msg.sender_user_id_,msg.chat_id_,function(arg,data)
if data.ID == "Error" then
StatusLeft(arg.chat_id_,our_id)
local NameGroup = Flter_Markdown(redis:get(veer..'group:name'..arg.chat_id_) or "")
...
local GetMsg = ScriptFile.iVeer(msg,{Text:match(Veer)})
if GetMsg then
...
redis:setex(veer..'sender:'..data.id_..':'..arg.chat_id_..'flood',300,true)
...
redis:del(veer..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_,
veer..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_,
veer..':photo:'..msg.chat_id_..':'..msg.sender_user_id_,
veer..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_,
veer..':voice:'..msg.chat_id_..':'..msg.sender_user_id_,
veer..':audio:'..msg.chat_id_..':'..msg.sender_user_id_,
veer..':animation:'..msg.chat_id_..':'..msg.sender_user_id_,
veer..':edited:'..msg.chat_id_..':'..msg.sender_user_id_,
veer..':video:'..msg.chat_id_..':'..msg.sender_user_id_,
veer..':Flood_Spam:'..msg.sender_user_id_..':'..msg.chat_id_..':msgs')
return false 
end
if not ScriptFile.dVeer(msg) then
print("\27[1;35m¦Msg_IN_Process : Proc _ Script.lua\27[0m")
end
end
for name,Plug in pairs(File) do
if Plug.Veer then 
if msg.text and not msg.forward_info_ and Plug.iVeer then
for k, Veer in pairs(Plug.Veer) do
if msg.text:match(Veer) then
...
function tdcli_update_callback(data)
	...
	download_file('https://raw.githubusercontent.com/SoKy-Master/SoKyBot/master/run','./run')
	EditMsg(data.message_.chat_id_,data.message_.id_,'20% - |███         |')
	download_file('https://raw.githubusercontent.com/SoKy-Master/SoKyBot/inc/Run.lua','./inc/Run.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'40% - |█████       |')
	download_file('https://raw.githubusercontent.com/SoKy-Master/SoKyBot/inc/locks.lua','./inc/locks.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'60% - |███████     |')
	download_file('https://raw.githubusercontent.com/SoKy-Master/SoKyBot/inc/Script.lua','./inc/Script.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'80% - |█████████   |')
	download_file('https://raw.githubusercontent.com/SoKy-Master/SoKyBot/inc/functions.lua','./inc/functions.lua')
	...
	download_file('https://raw.githubusercontent.com/SoKy-Master/SoKyBot/master/run','./run')
	download_file('https://raw.githubusercontent.com/SoKy-Master/SoKyBot/master/inc/Run.lua','./inc/Run.lua')
	download_file('https://raw.githubusercontent.com/SoKy-Master/SoKyBot/master/inc/Script.lua','./inc/Script.lua')
	download_file('https://raw.githubusercontent.com/SoKy-Master/SoKyBot/master/inc/functions.lua','./inc/functions.lua')
	download_file('https://raw.githubusercontent.com/SoKy-Master/SoKyBot/master/inc/locks.lua','./inc/locks.lua')
	...
	local NameGroup = Flter_Markdown(redis:get(veer..'group:name-100'..data.channel_.id_) or "")
